...
class GenerateEmbeddings:
    def __init__(self, input_file, output_file):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('ehsan0007/securebert_cwe_attack')
        self.model = AutoModel.from_pretrained('ehsan0007/securebert_cwe_attack')
...
output_path = "ft_securebert_revectorized_attack_data.txt"
