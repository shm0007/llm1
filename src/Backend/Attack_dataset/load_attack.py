...
attack_data_file_sci_bert = os.path.join(
    BASE_DIR,
    "scibert_revectorized_attack_data.txt"
)
attack_data_file_ft_sci_bert = os.path.join(
    BASE_DIR,
    "ft_scibert_revectorized_attack_data.txt"
)
attack_data_file_ft_sec_bert = os.path.join(
    BASE_DIR,
    "ft_secbert_revectorized_attack_data.txt"
)
attack_data_file_ft_bert = os.path.join(
    BASE_DIR,
    "ft_bert_revectorized_attack_data.txt"
)
attack_data_file_ft_roberta = os.path.join(
    BASE_DIR,
    "ft_roberta_revectorized_attack_data.txt"
)
...
attack_data_file_ft_secure_bert = os.path.join(
    BASE_DIR,
    "ft_securebert_revectorized_attack_data.txt"
)


attack_data_file_roberta = os.path.join(
    BASE_DIR,
    "roberta_revectorized_attack_data.txt"
)
attack_data_file_v2_securebert = os.path.join(
    BASE_DIR,
    "v2securebert_revectorized_attack_data.txt"
)

attack_data_file_securebert = os.path.join(
    BASE_DIR,
    "securebert_revectorized_attack_data.txt"
)
attack_data_file_secbert = os.path.join(
    BASE_DIR,
    "secbert_revectorized_attack_data.txt"
)
...
def load_attack_data_ft_sci_bert():
    attack_data = []
    embeddings = []
    with open(attack_data_file_ft_sci_bert, 'r', encoding='utf-8',errors='replace') as f:
        entry = {}
        embedding = []
        for line in f:
            line = line.strip()
...
def load_attack_data_ft_bert():
    attack_data = []
    embeddings = []
    with open(attack_data_file_ft_bert, 'r', encoding='utf-8',errors='replace') as f:
        entry = {}
        embedding = []
        for line in f:
            line = line.strip()
            if line.startswith("ID:"):
                ...
                if entry and embedding:
                    ...
                    embedding = []
    return attack_data, embeddings
def load_attack_data_ft_roberta():
    attack_data = []
    embeddings = []
    with open(attack_data_file_ft_roberta, 'r', encoding='utf-8',errors='replace') as f:
        entry = {}
        embedding = []
        for line in f:
            line = line.strip()
...
def load_attack_data_ft_sec_bert():
    attack_data = []
    embeddings = []
    with open(attack_data_file_ft_sec_bert, 'r', encoding='utf-8',errors='replace') as f:
        entry = {}
        embedding = []
        for line in f:
            line = line.strip()
            if line.startswith("ID:"):
                ...
                if entry and embedding:
                    ...
                    embedding = []
    return attack_data, embeddings
def load_attack_data_ft_secure_bert():
    attack_data = []
    embeddings = []
    with open(attack_data_file_ft_secure_bert, 'r', encoding='utf-8',errors='replace') as f:
        entry = {}
        embedding = []
        for line in f:
            line = line.strip()
...
# Load and parse the attack data file
def load_attack_data_sci_bert():
    attack_data = []
    embeddings = []
    with open(attack_data_file_sci_bert, 'r', encoding='utf-8',errors='replace') as f:
        entry = {}
        embedding = []
        for line in f:
            line = line.strip()
...
# Load and parse the attack data file
def load_attack_data_v2_secure_bert():
    attack_data = []
    embeddings = []
    with open(attack_data_file_v2_securebert, 'r', encoding='utf-8',errors='replace') as f:
        entry = {}
        embedding = []
        for line in f:
            line = line.strip()
...
# Load and parse the attack data file
def load_attack_data_roberta():
    attack_data = []
    embeddings = []
    with open(attack_data_file_roberta, 'r', encoding='utf-8',errors='replace') as f:
        entry = {}
        embedding = []
        for line in f:
            line = line.strip()
...
# Load and parse the attack data file
def load_attack_data_securebert():
    attack_data = []
    embeddings = []
    with open(attack_data_file_securebert, 'r', encoding='utf-8',errors='replace') as f:
        entry = {}
        embedding = []
        for line in f:
            line = line.strip()
...
def load_attack_data_secbert():
    attack_data = []
    embeddings = []
    with open(attack_data_file_secbert, 'r', encoding='utf-8',errors='replace') as f:
        entry = {}
        embedding = []
        for line in f:
            line = line.strip()
